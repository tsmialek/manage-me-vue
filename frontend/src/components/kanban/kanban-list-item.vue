...
<template>
  <div
    class="border-l-4 p-2 rounded-lg bg-white dark:bg-gray-800/30 relative space-y-3 break-words cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-800/50 hover:shadow-sm transition-all duration-200 ease-in-out"
    @click="emit('select')"
  >
